            ...
            <div className="px-5 sm:px-6 pt-5 pb-4">
              ...
              <div className="mt-6 space-y-3">
                {(() => {
                  ...
                  return sections.map((section) => {
                    if (section.type === "borders") {
                      ...
                      return (
                        <div key="borders-section" ref={(el) => { sectionRefs.current[BORDERS_KEY] = el; }} className="rounded-xl bg-rose-50/70 overflow-hidden">
                          <button
                            type="button"
                    ...
                    return (
                      <div key={group.id} ref={(el) => { sectionRefs.current[group.id] = el; }} className="rounded-xl bg-rose-50/70 overflow-hidden">
                        {isCollapsible ? (
                          <button
                            type="button"
                ...
                <div
                  ...
                  className="rounded-xl bg-rose-50/70 overflow-hidden"
                >
                  <button
                    type="button"
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <ChevronRight className={`h-5 w-5 transition-transform ${(expandedGroups[OBSERVATION_KEY] ?? false) ? "rotate-90" : ""}`} />
